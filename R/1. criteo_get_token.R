...
## TODO Переписать логику, чтобы не было чёрного ящика, выдавать пользователю сообщение об успешной авторизации.
## TODO Переименовать файл, чтобы get_token был первым, а авторизация второй
## TODO Переписать документацию в roxygen
